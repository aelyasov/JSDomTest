...
if ($('.dt-adv-search').html()!=null && $('.dt-first-search').html()!=null)
	...
	search_adv1=search_adv1 && $('.ui-slider-range.ui-widget-header').attr('style')=="left: 0%; width: 100%;" && $('input[name=s_iel]').is(':checked')==false && $('input[name=s_wel]').is(':checked')==false && $('input[name=s_pel]').is(':checked')==false && $('input[name=s_srel]').is(':checked')==false && $('input[name=s_amf]').is(':checked')==false && $('input[name=s_exc]').val()=='' && $('input[name=s_excp]').val()=='' && $('input[name=s_sp]').val()=='';
...
$(function() {
	var t=setTimeout(checkusernamefield,1500);
