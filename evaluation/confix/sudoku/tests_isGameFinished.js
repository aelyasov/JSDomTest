...
let dom2 = "<!DOCTYPE HTML><html><head><title>Test</title></head><body><div id='sudoku'></div></body></html>";
...
// cover branch (1,2); path = [1,2,7,8,9,10]
runTest(isGameFinished, dom2);

// cover branch (2,3), (4,6); path = [1,2,3,4,6,7,8,9,10]
runTest(isGameFinished, dom3);

// cover branch (4,5); path = [1,2,3,4,5,8,10]
