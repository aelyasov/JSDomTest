...
(function (isNode) {
    ...
    Instrumenter.prototype = {
		...
		// addNodeToTrace = astgen.statement(
		//     astgen.subscript(
		// 	astgen.dot(
		// 	    astgen.dot(
		// 		astgen.variable(this.currentState.trackerVar), 
		// 		astgen.variable('trace')),astgen.variable('push')
		// 	),
		// 	astgen.stringLiteral(sName)
		//     )
		// );
                //this.splice(astgen.sequence(incrStatementCount, addNodeToTrace), node, walker);
